...
public class Suspension extends Details {
    ...
    public Suspension(String name, String producer, String material, String type,
                      double weight, int serialNumber, boolean isPartOfTheChassis, String typeOfSuspension) {
